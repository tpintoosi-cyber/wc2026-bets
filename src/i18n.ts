...
export const T: Record<Lang, Translations> = {
  he: {
    ...
    ouCD: 'אנדר ⬇ = 0–2 שערים סה״כ במשחק  |  אובר ⬆ = 5+ שערים סה״כ  |  ניחוש נכון = נקודות בונוס',
  ...
  en: {
    ...
    ouCD: 'Under ⬇ = 0–2 total goals in match  |  Over ⬆ = 5+ total goals  |  Correct pick = bonus points',
